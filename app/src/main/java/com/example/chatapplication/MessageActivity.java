...
public class MessageActivity extends AppCompatActivity {
   ...
   // TextView username;
    ...
    private void sendMessage(String sender,String reciever,String message){
        ...
        mRef.child("Chats").child(sender).child(reciever).push().setValue(myMap);
        mRef.child("Chats").child(reciever).child(sender).push().setValue(myMap);
    }

    private void readMessage(final String myid, final String userid, final String Imageurl){

        mchats = new ArrayList<>();
        mRoot = FirebaseDatabase.getInstance().getReference().child("Chats").child(myid).child(userid);
